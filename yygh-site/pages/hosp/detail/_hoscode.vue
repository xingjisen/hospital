    ...
    <div class="page-container">
      <div class="hospital-detail">
        ...
        <div class="info-wrapper">
          <img :src="hospital.logoData" :alt="hospital.hosname"
...
import { getHospDetail } from "@/api/hosp";
...
export default {
  ...
  methods: {
    init() {
      getHospDetail(this.hoscode).then(response => {
        this.hospital = response.data.hospital;
        this.hospital.logoData = `data:image/jpeg;base64,${this.hospital.logoData}`;
      });
